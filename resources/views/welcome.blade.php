...
<head>
    ...
    <link rel="stylesheet" href="{{asset('klar/css/theme.min.css')}}">
...
<body class="bg-black text-white mt-0" data-bs-spy="scroll" data-bs-target="#navScroll">
        ...
        <div class="container">
            <a class="navbar-brand pe-md-4 fs-4 col-12 col-md-auto text-center" href="index.html">
                ...
                <img style="border-radius: 50%; width: 60px; height:60px;"
                    src="{{ asset('klar/img/LogoAndreaReyStudio.png') }}" />
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                @auth
                <a href="{{ url('/dashboard') }}" class="btn btn-outline-light">{{ __('Dashboard')}}</a>
                @else
    ...
    <main>
            ...
            <div class="container py-vh-4 position-relative mt-5 px-vw-5 text-center">
                <div class="row d-flex align-items-center justify-content-center py-vh-5">
                    ...
                    <div class="col-12 col-xl-8">
                        <p class="lead text-secondary">Cada mujer es única y hermosa a su manera. ¡Descubre tu belleza
                            interior y haz que brille!</p>
                    </div>
                    <div class="col-12 col-xl-8">
                        <p class="lead text-secondary">Porque cuidar tus manos y enmarcar tu mirada es más que un
                            servicio, es una declaración de estilo y confianza en ti misma.</p>
                    </div>
            ...
            <div class="container px-vw-5 py-vh-5">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7 text-lg-end" data-aos="fade-right">
                        ...
                        <!-- <span class="h5 text-secondary fw-lighter">Que Hacemos</span> -->
                        <h3 class="pt-5 fw-lighter">Que Hacemos</h3>
                    ...
                    <div class="col-12 col-lg-5" data-aos="fade-left">
                        <h3 class="pt-5 fw-lighter">Pestañas</h3>
                        ...
                        <img src="{{asset('klar/img/webp/image_2024_3_9_450.webp')}}" width="1116" height="848"
                            alt="abstract image" class="img-fluid position-relative rounded-5 shadow" data-aos="fade-up"
                            data-aos-duration="3000">
                        <h3 class="border-top border-secondary pt-5 mt-5 fw-lighter">Cejas</h3>
                        <!-- <p class="text-secondary">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
                            nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam
                            voluptua.<br>
                            <a href="#" class="link-fancy link-fancy-light me-2">Tell me more</a>
            ...
            <div class="container px-vw-5 py-vh-5">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-12 col-lg-5 bg-dark rounded-5 py-5" data-aos="fade">
                        ...
                        <h2 class="display-4">We constantly adding new images to our website. Does it make sense? No!
                        </h2>
                    </div>
                </div>
            </div>
                ...
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-12 col-lg-7 bg-dark rounded-5 py-vh-3 text-center my-5" data-aos="zoom-in-up">
                        <h2 class="display-huge mb-5">
                            <span class="fs-4 me-2 fw-light">$</span><span
                                class="border-bottom border-5">499</span><span class="fs-6 fw-light">/day</span>
                        </h2>
        ...
        <div class="container-fluid px-vw-5 position-relative" data-aos="fade">
            ...
            <div class="position-relative py-vh-5 bg-cover bg-center rounded-5"
                style="background-image: url({{asset('klar/img/webp/abstract12.webp')}})">
                <div class="container bg-black px-vw-5 py-vh-3 rounded-5 shadow">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-6 d-flex align-items-center bg-dark shadow rounded-5 p-0" data-aos="zoom-in-up">
                            <div class="row d-flex justify-content-center">
                                <div class="col-12">
                                    <img src="{{asset('klar/img/webp/person103.webp')}}" width="684" height="457"
                                        alt="our CEO with some nice numbers" class="img-fluid rounded-5" loading="lazy">
                                </div>
                                <div class="col-12 col-lg-10 col-xl-8 text-center my-5">
                                    <p class="lead border-bottom pb-4 border-secondary">"Lorem ipsum dolor sit amet,
                        ...
                        <div class="col-5 offset-1">
                            ...
                            <h2 class="display-huge fw-bolder border-top border-secondary pt-5 mt-5"
                                data-aos="zoom-in-left">78.981</h2>
                            <p class="h4 fw-lighter text-secondary">
                                Lorem ipsum dolor sit amet, consetetur sadipscing elitr.
                            </p>
                            <h2 class="display-huge fw-bolder border-top border-secondary pt-5 mt-5"
                                data-aos="zoom-in-left">98%</h2>
                            <p class="h4 fw-lighter text-secondary">
                                Lorem ipsum dolor sit amet, consetetur sadipscing elitr.
                            </p>
                        </div>
                ...
                <div class="row d-flex gx-5 align-items-center">
                    <div class="col-12 col-lg-6">
                        <div class="rounded-5 bg-black p-5 shadow" data-aos="zoom-in-right">
                            ...
                            <p class="text-secondary lead">"Lorem ipsum dolor sit amet, consectetur tempor incididunt ut
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="rounded-5 bg-black p-5 shadow mt-5 gradient" data-aos="zoom-in-left">
                            ...
                            <p class="lead">"Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
    ...
    <h2 class="ms-md-1 mt-1 h4 fw-lighter me-md-5">Agenda tu cita</h2>
    ...
    <script src="{{asset('klar/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{asset('klar/js/aos.js')}}"></script>
    <script>
    AOS.init({
